    ...
    return (
        <div className='flex flex-col h-fit gap-3 w-[85vw] lg:w-[49rem]'>
            ...
            <form className='flex flex-col h-fit gap-3 w-[85vw] lg:w-[49rem]'>
                ...
                <input type="text" className='h-[2.5rem] border-[1px] border-white bg-black rounded-lg' />
                ...
                {formType === "collection-curator" && (
                    <div className='flex flex-col h-fit gap-3 w-[85vw] lg:w-[49rem]'>
                        ...
                        <textarea cols={10} rows={5} className='border-[1px] max-w-[49rem] border-white bg-black rounded-lg' />
                    </div>
                )}
                {/* APPRAISALS */}
                {formType === "appraisals" && (
                ...
                <textarea cols={10} rows={10} className='border-[1px] max-w-[49rem] border-white bg-black rounded-lg' />
            </form>
        </div>
    )
}